...
const navigation = [
  ...
  { name: 'FriendRequests', href: '/friendRequests', current: false },
  ...
  return null;
        ...
        <header className="bg-white shadow-sm">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">{navigation.find(ele=>ele.href===pathname).name}</h1>
          </div>
        </header>
        <main>
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
